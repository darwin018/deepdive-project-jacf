    ...
    return (
        <div className={styles.dashboardHomeContainer}>
            ...
            <div className={styles.statsGrid}>
                <div className={`${styles.statCard} ${styles.blueCard}`} onClick={handleCardClick}>
                ...
                <div className={`${styles.statCard} ${styles.greenCard}`} onClick={handleCardClick}>
                    <div className={styles.statIcon}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <div className={`${styles.statCard} ${styles.yellowCard}`} onClick={handleCardClick}>
                    <div className={styles.statIcon}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <div className={`${styles.statCard} ${styles.orangeCard}`} onClick={handleCardClick}>
                    <div className={styles.statIcon}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <div className={`${styles.statCard} ${styles.redCard}`} onClick={handleCardClick}>
                    <div className={styles.statIcon}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <div className={`${styles.statCard} ${styles.purpleCard}`} onClick={handleCardClick}>
                    <div className={styles.statIcon}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
